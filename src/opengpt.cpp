...
void OpenGPT::on_sendRequestBtn_clicked()
{
    ...
    if (requestText.isEmpty()) {
        ...
        QByteArray requestBody = QString("{\"model\":\"gpt-3.5-turbo\",\"prompt\":\"%1\",\"temperature\":0.7,\"max_tokens\":150}").arg(requestText).toUtf8();
        ...
        QApplication::clipboard()->setText(textValue);
...
void OpenGPT::on_label_linkActivated(const QString &link) {
